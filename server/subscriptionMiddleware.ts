    ...
    if (freePlan) {
      req.subscription = {
        ...
        limits: {
          ...
          canCollaborate: freePlan.hasCollaboration,
          canExportPDF: freePlan.exportFormats?.includes("pdf") || false,
          canExportPNG: freePlan.exportFormats?.includes("png") || false,
          canExportCSV: freePlan.exportFormats?.includes("csv") || false,
          hasPermissionManagement: freePlan.hasPermissionManagement,
          hasSharedWorkspace: freePlan.hasSharedWorkspace,
          hasCommentsAndFeedback: freePlan.hasCommentsAndFeedback,
        }
      };
    }
    return next();
    ...
    if (plan) {
      req.subscription = {
        ...
        limits: {
          ...
          canCollaborate: plan.hasCollaboration,
          canExportPDF: plan.exportFormats?.includes("pdf") || false,
          canExportPNG: plan.exportFormats?.includes("png") || false,
          canExportCSV: plan.exportFormats?.includes("csv") || false,
          hasPermissionManagement: plan.hasPermissionManagement,
          hasSharedWorkspace: plan.hasSharedWorkspace,
          hasCommentsAndFeedback: plan.hasCommentsAndFeedback,
        }
      };
    }
