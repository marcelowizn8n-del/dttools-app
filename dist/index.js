...
var PPTXService = class {
  ...
  addTitleSlide(projectName, description = "") {
  ...
  addPhaseOverviewSlide(phase, title, description) {
    const slide = this.pres.addSlide({ masterName: "DTTools_MASTER" });
  ...
  async generateProjectPPTX(projectId) {
    try {
      ...
      if (empathyMaps2.length > 0 || personas2.length > 0) {
        this.addPhaseOverviewSlide(1, "Empatizar", "Compreenda profundamente seus usu\xE1rios atrav\xE9s de pesquisas, entrevistas e observa\xE7\xF5es.");
        empathyMaps2.forEach((empathyMap) => {
          this.addEmpathyMapSlide(empathyMap);
        });
        if (personas2.length > 0) {
          this.addPersonasSlide(personas2);
        }
      ...
      if (povStatements2.length > 0 || hmwQuestions2.length > 0) {
        this.addPhaseOverviewSlide(2, "Definir", "Defina claramente o problema e crie declara\xE7\xF5es de ponto de vista focadas.");
      ...
      if (ideas2.length > 0) {
        this.addPhaseOverviewSlide(3, "Idear", "Gere uma ampla gama de ideias criativas atrav\xE9s de brainstorming estruturado.");
        this.addIdeasSlide(ideas2);
        this.addDVFAnalysisSlide(ideas2);
      }
      if (prototypes2.length > 0) {
        this.addPhaseOverviewSlide(4, "Prototipar", "Construa prot\xF3tipos r\xE1pidos e baratos para testar suas melhores ideias.");
        const slide = this.pres.addSlide({ masterName: "DTTools_MASTER" });
      ...
      if (testPlans2.length > 0 || testResults2.length > 0) {
        this.addPhaseOverviewSlide(5, "Testar", "Teste seus prot\xF3tipos com usu\xE1rios reais e colete feedback valioso.");
  ...
  async generateProjectMarkdown(projectId) {
    try {
      const project = await storage.getProject(projectId);
      if (!project) {
        throw new Error("Project not found");
